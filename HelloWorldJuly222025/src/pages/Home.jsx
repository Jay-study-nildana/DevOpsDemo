    ...
    <div className="container mt-4">
      <div className="row align-items-center mb-4">
        <div className="col-md-8">
          ...
          <p className="lead">
            This is your journey into{" "}
            <span className="text-success">React 18.x</span> with Bootstrap 5.
            Explore, experiment, and enjoy building modern UIs!
          </p>
        </div>
        ...
        <div className="col-md-6">
          <div className="card shadow-sm h-100">
            <div className="card-body">
              <h5 className="card-title">Why React?</h5>
              <h5 className="card-title">Use Static Sites for deployment</h5>
      ...
      <div className="alert alert-info mt-4" role="alert">
        <strong>Tip:</strong> Use the navigation bar above to explore different
        pages and features!
      </div>
    </div>
  );
